...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@E_J_9"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('- ها ضلعي يمك بيرو اخدمني بشي | @r_a_h')
...
@sython.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع التريليون"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@fq0bot', 'جاري التجميع بواسطة | 𝐒𝐎𝐔𝐑𝐂𝐄 𝙩𝙝𝙚 𝙜𝙖𝙣𝙜')
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@fq0bot', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@fq0bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@fq0bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await sython.get_messages('@fq0bot', limit=1)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | 𝐒𝐎𝐔𝐑𝐂𝐄 𝙩𝙝𝙚 𝙜𝙖𝙣𝙜')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""
༗ 𝐖𝐄𝑳𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝙩𝙝𝙚 𝙜𝙖𝙣𝙜 🦅
༗ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐍 𝐓𝐄𝑳𝐄𝐆𝐑𝐀𝐌
༗ 𝐂𝐇𝐀𝐍𝐍𝐄𝑳 𝐒𝐎𝐔𝐑𝐂𝐄 : @E_J_9
"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""ᴛʜᴇ ᴅᴇᴠ ꜱᴏᴜʀᴄᴇ : @r_a_h"""
)
